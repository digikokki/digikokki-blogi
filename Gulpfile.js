...
//basics
config.siteName = 'Digikokki';
config.proxyDomain = 'dikokokki.dev';
...
gulp.task('inject-links', function () {
    gulp.src('templates/_includes/_layout.html')
    .pipe(inject(gulp.src(['web/bower_components/**/*.js'], {read: false}),
        // Options
        {
            ignorePath: ['web'],
            addRootSlash: false
...
// Call inject to sass
gulp.task('inject-sass', ['styles'], function(){
...
gulp.task('default', ['inject-sass', 'styles', 'scripts-individual', 'scripts-combined']);
